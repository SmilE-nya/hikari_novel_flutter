...
class _NovelDetailPageState extends State<NovelDetailPage> {
  ...
  Widget _buildLoadingPage() =>
      Scaffold(appBar: AppBar(), body: const LoadingPage());
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Wrap(
                spacing: 8,
                runSpacing: 8,
                children: controller.novelDetail.value!.tags
                    .map(
                      (e) => Chip(
                        label: Text(e),
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    ...
    return AppBar(
      ...
      actions: [
        IconButton(
          onPressed: controller.showExportDialog,
          icon: const Icon(Icons.file_download_outlined),
          tooltip: "export_novel".tr,
        ),
        IconButton(
                ...
                Flexible(
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () =>
                            AppSubRouter.toSearch(author: detail.author),
                        child: IconText(
                        ...
                        return ListTile(
                          ...
                          onTap: () async {
                            ...
                            final history = await DBService.instance
                                .getReadHistoryByCid(chapter.cid);
